        ...
        <Container>
          ...
          >
            <ScrollFadeIn delay={0.3}>
              <Title CN="text-4xl">BellaDent 치과
</Title>
            </ScrollFadeIn>
            <Text CN="text-lg">하얀치아 예쁜미소!!!
충치치료 치아교정 “앞으로도 의료계와의 소통을 통해 정확하고 신뢰받는 심사를 바탕으로 안전하고 수준 높은 적정진료 등으로 
우리의 건강과 아름다운 치아로 건강한 치아로 하얀치아와 미소로 우리의 행복한 삶을 만들어 미래를 함께 합니다</Text>
      ...
      <Container CN="text-center py-40">
        ...
        <RowBox CN="justify-center gap-20 pt-20">
          ...
          >
            ...
            <Text CN="text-lg">치과의 치료법 중 하나로, 충치나 풍치 치료의 최후처방인 발치 이후 치료법 중 하나이다.
어렵게 충치 치료를 결심했는데 없던 통증이 생겼다면 환자로서는 고통스러울 수밖에 없다. 치료를 또 해야 해서 치과 의료 분쟁의 주요 원인이 되기도 한다.
“충치 치료 후 통증 발생 가능성에 대해 미리 환자에게 충분히 설명을 해야 한다”며 “애초에 신경 치료를 하면 통증 발생 가능성은 없겠지만, 신경 등 자연치아는 최대한 보존하는 것이 좋다”고 할수 있으며 증상 호전이 없는 경우, 자극이 없는 데도 통증이 발생하는 등 증상이 악화되는 경우에는 치수염의 가능성을 염두에 두고 신경 치료를 진행해야 한다.</Text>
          </Card>
          <Card
            Scroll={true}
            image={home_sec_3_2}
          ...
          >
            ...
            <Text CN="text-lg">수술 시간은 보통 15분에서 한 시간 반 가량 되는데 수술의 범위, 임플란트 개수, 치조골 이식의 동반 여부에 따라 길어질 수도 있다. 여기에서 수술 시간이 짧으면 달인이라 생각할 수도 있지만, 대충 하는 경우도 있단 걸 기억해두자. 단순 임플란트가 아니라 치조골 이식을 동반하거나 여러 개를 심는 경우인데 너무 금방 끝났다면 합리적 의심을 해볼 수도 있으나 사실 그 정도로 양심 없는 치과의사는 극소수다. 행여 시간이 오래 걸렸다면 이 양반이 꼼꼼하게 하려고 하는구나 생각하면 된다.
임플란트는 그것을 심는 순간부터 죽을 때까지 한 사람과 평생을 함께하게 될 인공물이므로, 의식적으로 그것에 익숙해지고 자연스러워지는 적응기간을 갖게 된다</Text>
          </Card>
          <Card
            Scroll={true}
            image={home_sec_3_3}
          ...
          >
            ...
            <Text CN="text-lg">어렵게 충치 치료를 결심했는데 없던 통증이 생겼다면 환자로서는 고통스러울 수밖에 없다. 치료를 또 해야 해서 치과 의료 분쟁의 주요 원인이 되기도 한다. “애초에 신경 치료를 하면 통증 발생 가능성은 없겠지만, 신경 등 자연치아는 최대한 보존하는 것이 좋다”고 말했다.
최근 밝혀진 바에 따르면 치아 신경의 ‘역할’은 생각보다 크다. 온도 자극을 느끼는 것 뿐만 아니라 고유 수용 감각이 있어 저작 기능이 잘 이뤄질 수 있도록 돕는다.
“애초에 신경 치료를 하면 통증 발생 가능성은 없겠지만, 신경 등 자연치아는 최대한 보존하는 것이 좋다”고 말했다.
최근 밝혀진 바에 따르면 치아 신경의 ‘역할’은 생각보다 크다. 온도 자극을 느끼는 것 뿐만 아니라 고유 수용 감각이 있어 저작 기능이 잘 이뤄질 수 있도록 돕는다.</Text>
      ...
      <Container CN="py-40">
        ...
        >
          ...
          <Text CN="text-lg">"치아교정치료 목적으로 촬영한 저선량 엑스레이 영상 검사로 뇌, 안면부의 심각한 질환을 무증상 상태에서 조기 발견이 가능했다는 점에 주목해야 한다"면서 ”이를 통해 치과적 문제점 외에도 의학적 질환 진단에 도움이 됐고 신속한 진료 연계로 그 치료성적 또한 우수했음을 증명했기에 치아 상태 연구라고 평가하여 연구하고 설명을 하여 치아상태 여러 가지 설명으로 밝혔다.</Text>
          <Button CN="bg-BD-CharcoalBlack text-BD-ElegantGold w-40 py-4 rounded-2xl text-md mt-4">
            button
          </Button>
        </Card>
      ...
      <Wrapper CN="py-40">
        <Container>
          ...
          >
            <ScrollFadeIn delay={0.3}>
              <Title CN="text-4xl">치과 치료 과정
</Title>
            </ScrollFadeIn>
            <Text CN="text-lg">치과 엑스레이 이미지 분석을 통해 ▲악안면부에 생길 수 있는 낭, 양성 종양, 악성 종양 및 기타 골질환 ▲턱관절의 퇴행성골관절염 ▲림프절 석회화 등의 진단에 기여했고 의학적 치료에 연계돼 조기 치료에 도움이 된다고 판단했다.악안면부에 생길 수 있는 낭, 양성 종양, 악성 종양 및 기타 골질환 진단이 의미가 있는 이유는 임상적 증상 없이 커지는 경우가 많아 주의가 필요한 질환들이기 때문이다. 증상이 나타나 병원을 찾게 되면 치료 범위가 너무 광범위하거나 예후가 나쁜 경우가 많은 질환으로 조기 발견이 중요하다.</Text>
            <Button CN="bg-BD-CharcoalBlack text-BD-ElegantGold w-40 py-4 rounded-2xl text-md mt-4">
              button
            </Button>
          </Card>
