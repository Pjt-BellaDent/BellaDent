    ...
    <>
      ...
      >
        <div className="flex flex-col justify-center items-center">
          <Title CN="text-4xl text-center text-BD-CharcoalBlack text-shadow-lg/20"><b>교정 / 미용치료</b></Title>
          <Text CN="text-xl text-center">Orthodontics/cosmetic treatment</Text>
        </div>
      </LineImageBanner>
      <div>
        ...
        <div className="max-w-300 mx-auto mt-15 mx-15">
          <b className=" flex justify-center md:text-balance text-[24px] mt-[80px] mb-6 mx-5">
            턱관절치료안내
          </b>
          <div className="mx-5">
            <p className="text-[24px] line-clamp-15 text-justify">
