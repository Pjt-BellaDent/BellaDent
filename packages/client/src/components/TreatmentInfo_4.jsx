  ...
  return (
    ...
    <div>
      <div className="justify-center max-w-300 mx-auto relative">
        ...
        <h2 className="text-center mt-10 mb-6">
          
        </h2>
        <h3 className="text-center mt-16 mb-3 mx-10">
          <b>치아교정안내</b>
        </h3>
        <b>치아교정 치료의 주요 목적</b>
         <hr className="my-2 mt-20 mx-10" />
        <div className="flex gap-7 mx-5">
          ...
          <p className="text-blue-600 dark:text-sky-400">
            ...
            치료 방법입니다. 비정상적인 치아와 턱의 위치는 예쁘지 않은 모습을 만
            수도 있습니다. 치아교정 치료는 단순히 외모 개선을 위한 것 뿐만
            아니라 올바른 구강 기능과 건강을 유지하는 데에도 큰 도움을 줄 수
            있습니다.
            <br /> 예쁜 미소와 자신감 향상: 앞니가 앞으로 돌출되어 있는 경우에는
            사람들이 환자를 보고 일반적으로 좋지 않은 인상을 받을 수 있습니다
            비정상적인 치아와 턱의 위치를 치아교정을 통해 바로잡으면 예쁜 미소와
            자신감을 가질 수 있습니다. 치아가 너무 밖으로 돌출되어 있는 경우에는
            이를 보호하기 위해 입술이나 혀가 치아를 덮으려고 압력을 가할 수 있어
            이는 입술과 혀에 손상을 일으킬 수 있고, 치아에도 부담을 주어 치아의
            이상적인 기능을 방해할 수 있습니다
          </p>
        </div>
        <hr className="my-2 mt-10 mb-6 mx-5" />
        <h3 className="flex justify-center md:text-balance mt-10 mb-6 mx-5">
          <b>미백/라미네이트</b>
        </h3>
        <div className="flex gap-12 flex-row-reverse justify-between mx-5">
          <img src={image} alt="image" />
          <p className="text-blue-600 dark:text-sky-400">
            라미네이트란 자연치아를 거의 그대로 유지하면서 변색, 손상, 형태이상,
            파절 또는 치아 사이가 벌어져 못 생겨진 치아를 <br />
            정상적인 모양으로 복원하는 시술로 치과 시술 중 가장 심미적인
            영역이라고 할 수 있습니다.
            <br />
            치아미백에 원리는 변색된 치아에 H2O2, Carbamide peroxide가 주성분인
            미백제를 도포하여 색소물질을 산화시키는 것입니다.
            <br />
            치아미백은 미백제가 치아 속으로 스며들어 치아 속까지 하얗게 만드는
            것으로
            <br />
            치아미백을 받은 후에 하얗게 느껴지는 상태는 3-5년간 지속됩니다.
            <br />
            색소가 들어간 주스, 유색소 과일, 카레, 커피, 담배, 탄산음료, 김치
            등은 미백시술 효과를 떨어트릴 수 있습니다. <br />
        ...
        <hr className="my-2 mt-10 mb-6 mx-5" />
        <div className="max-w-300 mx-auto"></div>
        <div className="w-full relative">
          <img src={dgim} alt="dgim" />
        ...
        <div className="mx-5">
          <p>
            ...
            턱관절 질환으로 인한 <br />
            통증, 염증, 근육 경련 등을 완화하고 세포 재생을 촉진하여 빠른 회복을
            돕는 데 사용됩니다.
            <br />
        ...
        <dir className="flex  gap-7 mx-5">
          ...
          <div>
            <p className="flex justify-center gap-2 mt-10 mx-5">
              <strong>레이저</strong>
            </p>
            <p>
            ...
            <p>
              레이저는 치아를 자르거나 잇몸을 절개할 때 열 손상을 최소화하고, 치료
              효과를 높이며, 붓기나 통증을 줄여주는 장점이 있습니다.
            </p>
            <p>
              잇몸 레이저: 잇몸 수술 시 열 손상을 줄이고 통증과 붓기를
              최소화합니다. 절개, 봉합을 최소화하여 회복이 빠릅니다. 충치 치료:
              물방울 레이저를 사용하여 충치 부위를 제거하고, 적은 통증으로 치료가
              가능합니다. 지각 과민증: 치아 표면에 레이저를 조사하여 지각 과민증을
              완화합니다.
            </p>
          </div>
        </dir>
      ...
      <div className="w-full relative">
        ...
        <div className="text  absolute inset-0 left-[50%] top-[50%]">
          <p>
            치주 질환: 치주 질환 치료 시 잇몸을 절개하지 않고, 레이저를 사용하여
            치주낭을 제거하고 잇몸을 재생시킵니다.
          </p>
          <p>
