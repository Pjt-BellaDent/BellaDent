    ...
    <>
      ...
      <div>
        <div className="justify-center max-w-300 mx-auto relative">
          <h2 className="text-center text-[48px] mt-16 mb-20 mx-10">
            <b>치아교정안내</b>
          </h2>
          ...
          <div className="flex gap-7 mt-8 mx-5">
            <img src={teeth1} alt="teeth1" />

            <p className="text-[24px] text-blue-600 dark:text-sky-400">
          ...
          <h3 className="flex justify-center md:text-balance text-[24px] mt-10 mb-6 mx-5">
            <b>미백/라미네이트</b>
          </h3>
        ...
        <div className="max-w-300 mx-auto">
          <hr className="my-2 mt-10 mb-6 mx-5" />
          <b className="text-[24px] mx-5">턱관절치료안내</b>
          <div className="mx-5">
            <p className="text-[24px]">
          ...
          <dir className="flex  gap-7 mx-5">
            ...
            <div>
              <p className="flex justify-center gap-2 text-[24px] mt-10 mx-5">
                <strong>레이저</strong>
              </p>
              <p className="text-[24px]">
        ...
        <div className="max-w-300 mx-auto">
          <hr className="my-2 mt-10 mb-6 mx-5" />
          <div>
            <p className="text-center text-[24px] mt-6 mb-3">장비와 시스템</p>
            ...
            <p className="text-center text-[24px] mt-15 mb-3">
              치아 교정 시스템
            </p>
