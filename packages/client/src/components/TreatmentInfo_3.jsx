        ...
        <div>
          <div className="flex gap-12 mx-5 justify-between">
            ...
            <div className=" mt-10 mb-6 max-w-full flex-1">
              <p className="text-[24px] mt-6 mb-3 ">
                <b>3D-CT EXO-X</b>
              </p>
              <p className="text-[24px]">저선량CT</p>
              <p className="text-[24px] line-clamp-9 text-justify">
             ...
             CBCT 영상구현이 가능합니다.
                ...
                치아의 신경을 치료하는 과정입니다. 
                치아 내부의 신경 조직을 제거하고 소독 및 충전재로 채운 후,
                약해진 치아를 보호하기 위한 크라운 치료를 진행합니다.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-12 mx-5 flex-row-reverse justify-between">
            ...
            <div className="mt-10 mb-6 max-w-full flex-1">
              ...
              <p className="text-[24px] mt-6 mb-3 line-clamp-15 text-justify">
               <p className='mt-6 mb-3'><b>턱관절물리치료 PHL레이저</b></p>
                ...
                장비로는 PHL-15 레이저가 있습니다.
                  ...
                  이것은 Perfect Healing Laser를 줄인 말로써 저출력 레이저를
                  이용해 턱관절 주변의 근육을 자극하고 통증을 완화시켜 주는
                  역할을 합니다.
          ...
          <div className="flex gap-12 mx-5 ">
            <div className="mt-10 mb-6 w-full flex-1">
              <img src={dentalchair} alt="dentalchair" className='w-full block'/>
            </div>
            <div className="mt-10 mb-6 max-w-full flex-1">
              <p className="text-[24px] mt-6 mb-3 line-clamp-15 text-justify">
                <b>3차원 디지털 CT의 특별함</b>
              </p>
              <p className="text-[24px]">컴퓨터 단층 촬영/Facial CT
             
                수년간 축적된 코성형 노하우를 바탕으로 코의 외형적인 모양과 함께
                겉으로는 알 수 없었던 코뼈, 비중격연골,
              
            
                하비갑개의 상태를 코 성형 전문 3D CT 촬영을 통해 입체적이고
                정밀한 분석과 개인별 맞춤형 수술이 가능합니다.</p>
          ...
          <div className="flex gap-12 flex-row-reverse justify-between mx-5">
            <div className="mt-10 mb-6 w-full flex-1">
              <img src={chigwasecheoggi} alt="chigwasecheoggi" className='w-full block'/>
            </div>
            <div className="mt-10 mb-6  max-w-full flex-1">
              <p className="text-[24px] mt-6 mb-3  line-clamp-15 text-justify">
                 <p className='mt-6 mb-3'><b>세척기</b></p>
          ...
          <hr className="mt-3 mb-6" />
          <div className="flex gap-12 mx-5 mb-15  justify-between">
            <div className="mt-10 mb-6  w-full flex-1">
              <img src={Laser} alt="Laser" className='w-full block'/>
            </div>
            <div className="mt-10 mb-6 max-w-full flex-1">
              <p className="text-[24px] mt-6 mb-3 line-clamp-15 text-justify">
                <p className='mt-6 mb-3'><b>임플란트</b></p>
              <p>적은 통증 안전하게 레이저</p>
