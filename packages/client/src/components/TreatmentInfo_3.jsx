  ...
  return (
    <>
      ...
      <div className=" max-w-300 mx-auto relative">
        <div>
          <h1 className="flex justify-center md:text-balance mt-10 mb-6"></h1>
          <h2 className="flex justify-center text-[48px] mt-10 mb-6">
            <b>충치치료장비 </b>
          </h2>
        </div>
        ...
        <div>
          <div className="flex gap-12 mx-5">
            ...
            <div className=" mt-10 mb-6">
              ...
              <p className="text-[24px] text-justify">저선량CT</p>
              <p className="text-justify main-text text-[24px]">
              ...
              <p className="text-justify text-[24px]">
                ...
                약해진 치아를 보호하기 위한 <br /> 크라운 치료를 진행합니다.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-12 mx-5">
            ...
            <div className="mt-10 mb-6">
              ...
              <p className="text-[24px]">컴퓨터 단층 촬영/Facial CT</p>
              <p className="text-[24px] main-text">
                수년간 축적된 코성형 노하우를 바탕으로 코의 외형적인 모양과 함께
                겉으로는 알 수 없었던 코뼈, 비중격연골,
              </p>
              <p className="text-[24px]">
                하비갑개의 상태를 코 성형 전문 3D CT 촬영을 통해 입체적이고
                정밀한 분석과 개인별 맞춤형 수술이 가능합니다.
              </p>
            </div>
          </div>
          <hr className="mt-3 mb-6" />
          <div className="flex gap-12 flex-row-reverse justify-between mx-5">
            ...
            <div className="mt-10 mb-6">
              ...
              <p className="text-[24px]">초음파 세척기</p>
              <p className="text-[24px] main-text">
          ...
          <div className="flex gap-12 mx-5 mb-15">
            ...
            <div className="mt-10 mb-6">
              ...
              <p className="text-[24px]">적은 통증 안전하게 레이저</p>
              <p className="text-[24px]">
